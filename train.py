...
from utils import get_all_data_loaders, get_all_data_loaders_centercrop
import argparse
...
trainer.cuda(device)
get_loaders = get_all_data_loaders_centercrop if opts.centercrop else get_all_data_loaders
train_loader_a, train_loader_b, test_loader_a, test_loader_b = get_loaders(config)
