...
"""
from utils import get_all_data_loaders_centercrop, prepare_sub_folder, write_html, write_loss, get_config, write_2images, Timer
import argparse
...
trainer.cuda(device)
train_loader_a, train_loader_b, test_loader_a, test_loader_b = get_all_data_loaders_centercrop(config)
